...
method {:test} test9() {
var r0 := Uint8_16.Uint16Seq.SeqZero(1);
}
method {:test} test10() {
var r0 := Uint8_16.Uint16Seq.FromNatWithLen(1236, 1);
}
method {:test} test11() {
var r0 := Uint8_16.Uint16Seq.SeqExtendMultiple([0, 0], 3);
}
method {:test} test12() {
var r0 := Uint8_16.Uint16Seq.SeqExtend([0], 1);
}
method {:test} test13() {
var r0 := Uint8_16.Uint16Seq.SeqExtend([0, 0, 0, 0, 0, 0], 7);
}
method {:test} test14() {
var r0 := Uint8_16.Uint16Seq.FromNat(2279);
}
method {:test} test15() {
var r0 := Uint8_16.Uint16Seq.FromNat(0);
}
method {:test} test16() {
...
method {:test} test24() {
var r0 := Uint8_16.Uint8Seq.SeqZero(1);
}
method {:test} test25() {
var r0 := Uint8_16.Uint8Seq.FromNatWithLen(1236, 1);
}
method {:test} test26() {
var r0 := Uint8_16.Uint8Seq.SeqExtendMultiple([0, 0], 3);
}
method {:test} test27() {
var r0 := Uint8_16.Uint8Seq.SeqExtend([0], 1);
}
method {:test} test28() {
var r0 := Uint8_16.Uint8Seq.SeqExtend([0, 0, 0, 0, 0, 0], 7);
}
method {:test} test29() {
var r0 := Uint8_16.Uint8Seq.FromNat(2279);
}
method {:test} test30() {
var r0 := Uint8_16.Uint8Seq.FromNat(0);
}
method {:test} test31() {
